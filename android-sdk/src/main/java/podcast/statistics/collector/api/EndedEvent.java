...
public class EndedEvent extends Event {
    ...
    private EndedEvent(@Nullable String client,
    ...
    public static class Builder {
        ...
        public EndedEvent create() {
            return new EndedEvent(client, author, title, podcastName, publisher, playbackRate, volume,
